...
<body>
	<div class="welcome">
		...
		<div class="dropdown">
                                <div class="icon-box icon-box-inverse dropdown-toggle cursor-pointer"
                                     data-toggle="dropdown">
                                    <i class="fa fa-0.5x fa-user background-i"></i>

                                    <div class="icon-box-content padding-top-bottom-0 background-iconboxcontent align-middle">
                                        <h4>
                                            Connexion
                                        </h4>
                                    </div>
                                ...
                                <div class="dropdown-menu dropdown-login"
                                    ...
                                    {{ Form::open(['route' => 'user.login', 'id' => 'loginform', 'name'=>'loginform']) }}
                                    <h4 class="section-title"><FONT color="#01B7F1">Connexion</FONT></h4>
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="rememberme" id="rememberme" value="forever"
                                                       tabindex="90"> Se souvenir de moi
                                            </label>
                                        </div>
                                        <div>
                                            <a href="{{ URL::route('password.remind')}}">J'ai perdu mon mot de passe</a>
                                        </div>
                                        <input type="hidden" name="redirect_to"
                                               value="http://razonartificial.com/themes/openmind/wordpress">
                                        <input type="hidden" name="testcookie" value="1">
                                        <button type="submit" class="btn btn-blue-login pull-right" name="wp-submit"
                                                id="wp-submit">Login
                                        </button>
                                    </div>
                                    {{ Form::close() }}
