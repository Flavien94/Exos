...
<body>
	...
	if($nbEvents) {
      ...
      <tr><td>'.'Du '.html_entity_decode($evenement['date_debut']).' au '.html_entity_decode($evenement['date_fin']).'</td></tr>
            <tr><td>Titre :</td></tr>
        <tr><td>'.html_entity_decode($evenement['titre_evenement']).'</td></tr>
            <tr><td>Description :</td></tr>
				<tr><td>'.html_entity_decode($evenement['contenu_evenement']).'</td></tr>
				<tr><td><a href="traitement/supprevent.php?id='.$evenement['id_evenement'].'">Supprimer</a></td></tr>
			</table>
			<br/><br/>
			';
		}
